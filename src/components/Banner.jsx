        ...
        <div className="flex md:flex-row flex-col-reverse gap-5 justify-center items-center">
          <div className=" flex justify-start">
            <div className="text-start md:text-end space-y-4 text-white">
              <h4
                className="bg-white/10 flex justify-end gap-2 items-center  backdrop:blur-lg text-end font-semibold p-2"
                style={{ borderRadius: "10px 0 10px 0" }}
              >
                Hi <FaHandPeace className="text-yellow-400" />, I'm
              </h4>
              <h2
                ref={ref}
                onMouseOver={replay}
              ...
              <div className="text-yellow-400 ">
                ...
                <div className="quote  text-sm md:whitespace-nowrap">
                  <h1 className="quote-mark-font">
                    <span className="quote-mark">&lt;</span>The expert in
                    anything was once a beginner.
                    <span className="quote-mark">&gt;</span>
                    <br />
                    <span className="font-semibold mt-3 inline-block">
                      - Helen Hayes
                    </span>
                  </h1>
                </div>
